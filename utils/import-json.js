    ...
    try {
      await db.execute(
        ...
        [
          ...
          testcase.input_value === undefined ? "" : testcase.input_value,
          ...
          testcase.time_limit === undefined ? 1 : testcase.time_limit,
          testcase.description === undefined ? "" : testcase.description,
          testcase.input === undefined ? "" : testcase.input,
        ]
      );
    } catch (error) {
      console.error(
